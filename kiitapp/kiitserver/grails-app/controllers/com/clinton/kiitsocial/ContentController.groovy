...
class ContentController {
    ...
    def index(Integer max) {
        ...
        def announcements = Announcement.list(params)
        def article = Article.list(params)
        def event = Event.list(params)
        List<Content> contentList = [announcements, article, event]
